...
impl LockFile {
    ...
    pub fn verify_package(
        ...
        let locked = self.get_package(name).ok_or_else(|| LockError::PackageNotLocked {
            name: name.to_string(),
        })?;
...
mod tests {
    ...
    fn test_lock_file_generates_with_exact_versions() {
        ...
        assert_eq!(pkg.sha256, "b8cc24c9574d809e7279c3be349795c5d5ceb6fdf19ca709f80cde50e47de314");
    }
    ...
    fn test_lock_file_zig_version_in_toml() {
        ...
        assert!(toml.contains("zig_version = \"0.13.0\""), "TOML should contain zig_version");
    }
    ...
    fn test_lock_file_source_git() {
        ...
        assert_eq!(pkg.source, Some("git:https://github.com/myorg/nginx-fork#v1.24.0".to_string()));
    }
    ...
    fn test_lock_file_source_custom_registry() {
        ...
        assert_eq!(pkg.source, Some("registry:https://packages.mycompany.com".to_string()));
    }
    ...
    fn version_strategy() -> impl Strategy<Value = String> {
        proptest::string::string_regex("[0-9]+\\.[0-9]+\\.[0-9]+")
            .unwrap()
    }
